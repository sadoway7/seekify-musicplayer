...
func InitSettingsTable() {
	...
	MigrateSetting("waveform_style", "squiggle")
	...
	MigrateSetting("transcode_enabled", "true")
	MigrateSetting("transcode_bitrate", "192")
	MigrateSetting("review_enabled", "true")
	MigrateSetting("review_recheck_hours", "24")
	MigrateSetting("data_saver_enabled", "true")
	MigrateSetting("data_saver_interval_hours", "6")
	MigrateSetting("watched_enabled", "false")
	...
	MigrateSetting("review_flag_no_cover", "false")
